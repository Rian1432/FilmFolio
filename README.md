...
Projeto criado para desenvolvimento da disciplina DESENVOLVIMENTO DE APLICAÇÕES FRONTEND WEB COM FRAMEWORKS E COMPONENTES.
O frontend da aplicação foi desenvolvido com Angular e o backend foi simulado pela implementação de uma API Fake, usando o JSON Server.

## Endereço de Deploy - GitHub Pages

* [Link do website](https://film-folio-five.vercel.app/filmes-e-series)

## Protótipo

* [Protótipo no figma](https://www.figma.com/file/s6gxwWy8HPMCmPHQ2plDqW/Project?type=design&node-id=0%3A1&mode=design&t=KDxyXQjmyQTOFgAj-1)
